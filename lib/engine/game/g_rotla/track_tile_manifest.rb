...
module Engine
  module Game
    module GRotLA
      ...
      # descriptive rather than Engine tile DSL: exact edge/node tracing and
      # upgrade-family symbols must be verified before this feeds Map::TILES.
      module TrackTileManifest
        ...
        TILES = [
          ...
          tile('RLA-Y06', :yellow, 1, :city_three_way, 6, 64, 247.257, 452.437),
          ...
          tile('RLA-G01', :green, 4, :three_way_junction, 10, 211, 165.855, 413.503),
          tile('RLA-G02', :green, 4, :three_way_junction, 11, 199, 199.022, 413.503),
          tile('RLA-G03', :green, 2, :three_way_junction, 12, 193, 232.189, 413.503),
          ...
          tile('RLA-G13', :green, 5, :two_city, 22, 142, 103.706, 351.314),
          tile('RLA-G14', :green, 4, :two_city, 23, 304, 69.864, 352.472),
          tile('RLA-G15', :green, 4, :two_city, 24, 130, 135.811, 352.472),
          ...
          tile('RLA-G20', :green, 2, :two_city, 32, 124, 152.356, 323.703),
          tile('RLA-G21', :green, 2, :two_city, 33, 118, 185.951, 323.703),
          tile('RLA-G22', :green, 1, :two_city, 34, 54, 217.808, 324.862),
          tile('RLA-G23', :green, 1, :two_city_special, 35, 58, 249.665, 324.862),
          tile('RLA-G24', :green, 1, :two_city_special, 36, 56, 281.940, 324.862),
          ...
          tile('RLA-P11', :purple, 6, :two_city, 44, 100, 53.888, 259.642),
          tile('RLA-P12', :purple, 2, :three_city, 46, 85, 85.725, 261.964),
          tile('RLA-P13', :purple, 1, :three_city_special, 47, 50, 117.848, 263.123),
          tile('RLA-P14', :purple, 1, :four_city_special, 48, 52, 149.971, 263.123),
          tile('RLA-P15', :purple, 1, :crossing_paths, 49, 22, 182.095, 263.123),

          tile('RLA-X01', :gray, 3, :two_city, 45, 91, 217.694, 260.805),
          tile('RLA-X02', :gray, 1, :three_city, 50, 60, 249.817, 263.123),
          tile('RLA-X03', :gray, 1, :three_city_special, 51, 62, 281.940, 263.123),
